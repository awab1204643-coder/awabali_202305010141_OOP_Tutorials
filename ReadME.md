...
* **Name:** AWWAB SADELDIN AHMED ALI
* **Student ID:** 202305010141
* **Class Code:** BIT1123
* **Programme:** Bachelor of Software Engineering (BSSCE)
...
Each folder contains the Java source code and supporting files related to the corresponding tutorial.
...
These concepts were gradually introduced and practiced through different tutorial exercises.
...
Open the terminal inside the required tutorial folder and compile the Java file:
...
For the Week 10 GUI project, compile the required Java files and run:
...
The exact files required may differ depending on the tutorial.
...
A detailed self-reflective report is included in this repository as:
